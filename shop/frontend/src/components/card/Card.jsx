...
const Card = ({product}) => {
    ...
    return (
        <li className="card wrapper" key={id}>
            <div className="product-header">
                <div className="product-logo_wrapper">
                    <a href="#">
                        <img className="product-logo_img"
                             src={img}
                ...
                <div className="product-title_block">
                    <div className="product-title">{productDescription}</div>
            ...
            <div className="product-footer">
                ...
                <div className="product-button">
                    ...
                    <span className="product-button_title">В корзину</span>
                </div>
            </div>
        </li>
)
